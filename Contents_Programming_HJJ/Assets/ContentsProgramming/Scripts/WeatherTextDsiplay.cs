...
public class WeatherTextDisplay : MonoBehaviour
{
    ...
    public void ChangeToSummer()
    {
        ...
        locationName = "Summer Seoul";       // 봄여름 테마 지역명
    ...
    {
        // 여름 설정값들
        currentTemperature = 13.0f;      // 가을 온도: 13도
        locationName = "Autumn Seoul";       // 가을 테마 지역명
    ...
    {
        // 여름 설정값들
    currentTemperature = -1.0f;      // 겨울 온도: -1도
    locationName = "Winter Seoul";       // 겨울 테마 지역명
